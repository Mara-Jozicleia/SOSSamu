...
class DetailCallView: UIView {
    ...
    lazy var backButton: UIButton = {
        ...
        let button = ButtonView(backgroundColor: .viewO, titleColor: .white, text: "❮", font: UIFont(name:"Arial", size: 24), cRadius: 0, border: 0)
    ...
    lazy var patientAddressLabel: UILabel = {
        ...
        let label = LabelView(text: " R Cidade Beloma, 55 - Santa Teresinha", textColor: .textColor, font: UIFont(name: "Euphemia UCAS", size: 17), nLines: .zero)
        label.textAlignment = .left
    ...
    private func setupChamadoLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            chamadoLabel.bottomAnchor.constraint(equalTo: headerView.bottomAnchor, constant: -8),
            chamadoLabel.rightAnchor.constraint(equalTo: headerView.rightAnchor, constant: -16),
            chamadoLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 16),
        ])
    ...
    private func setupLocationView() {
        ...
        NSLayoutConstraint.activate([
            ...
            locationView.heightAnchor.constraint(equalTo: self.heightAnchor, multiplier: 0.28),
